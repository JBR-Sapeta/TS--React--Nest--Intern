...
export function CompanyOfferView(): ReactElement {
  ...
  return (
    <ContentRow margin="medium">
      {company && (
        <WrappedFullOffer company={company} offerId={numericOfferId} isOwner />
      )}
    </ContentRow>
  );
}
